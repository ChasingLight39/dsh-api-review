...
if [ -z "$CHECKOUT" ]; then
  for candidate in "$HOME/dsh-harness" "$HOME/dsh" "$HOME/.dsh/dsh-harness" "$(cd "$ROOT/.." && pwd)/deepseek-harness"; do
...
link_pkg @deepseek-ai/dsh-user-questions packages/interaction/user-questions
